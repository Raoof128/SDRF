...
class AzureDetector(RegexEngine):
    ...
    def detect_azure_credentials(self, text: str, file_path: str = "unknown") -> List[SecretFinding]:
        ...
        for finding in findings:
            ...
            if "client_id" in finding.secret_type or "tenant_id" in finding.secret_type:
                ...
                match = re.search(r"[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}", finding.secret_value, re.IGNORECASE)
                if match:
                    guid = match.group()
    ...
    def detect_certificate_keys(self, text: str, file_path: str = "unknown") -> List[SecretFinding]:
        ...
        cert_patterns = [
            ...
            (r"-----BEGIN PRIVATE KEY-----[\s\S]+?-----END PRIVATE KEY-----", "private_key", "critical"),
            (r"-----BEGIN RSA PRIVATE KEY-----[\s\S]+?-----END RSA PRIVATE KEY-----", "rsa_private_key", "critical"),
        ]

...
class ConfigManager:
    ...
    def __init__(
        ...
        # Configuration files
        self.patterns_file = Path(patterns_file) if patterns_file else self.config_dir / "patterns.json"
        self.policies_file = Path(policies_file) if policies_file else self.config_dir / "rotation_policies.yaml"
...
def init_config(patterns_file: Optional[str] = None, policies_file: Optional[str] = None) -> ConfigManager:
